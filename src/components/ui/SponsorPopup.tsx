        ...
        >
          ...
          >
            <button
              ...
              className="absolute -right-2 -top-2 z-[101] rounded-full bg-white p-1 text-gray-500 shadow-md hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
            >
              <X size={20} />
            </button>
