...
const Footer = () => {
	return (
		<footer style={{ backgroundImage: 'url("footer/footer_bg.svg")', backgroundRepeat: 'no-repeat' }}
			...
			<div className="flex flex-wrap justify-center md:justify-end md:gap-24 lg:gap-48">
				<div className='basis-1/2 md:basis-0'>
					...
					<div style={space.style} className="flex flex-col text-base mt-2">
						<a className="my-1" href="#about" data-lenis-prevent>About</a>
						<a className="my-1" href="#tracks" data-lenis-prevent>Themes</a>
						<a className="my-1" href="#timeline" data-lenis-prevent>Timeline</a>
						<a className="my-1" href="#organizers" data-lenis-prevent>Team</a>
						<a className="my-1" href="#sponsors" data-lenis-prevent>Sponsors</a>
						<a className="my-1" href="#faqs" data-lenis-prevent>FAQs</a>
						<a className="my-1" href="#contact" data-lenis-prevent>Contact Us</a>
						<a className="my-1" href="https://github.com/MLH/mlh-policies/blob/main/code-of-conduct.md" data-lenis-prevent>MLH Code of Conduct</a>
					</div>
				</div>
				<div className='basis-1/2 md:basis-0'>
					<p style={outfit.style} className='text-xl text-white'>Join Us</p>
					<div style={space.style} className="flex flex-col text-base mt-2">
						<a href="https://github.com/dscvitc/dscvitchennai" className='flex gap-2 my-1' data-lenis-prevent>
				...
				<div className='my-4 md:my-0'>
					...
					<div className="flex justify-center gap-2">
						<a href="https://www.instagram.com/devshouse.in?igsh=dWp5MjZ0eTdmMGc4" target="_blank" rel="noopener noreferrer" data-lenis-prevent>
							<Image style={{ height: 40, width: 'auto' }} src='footer/insta.svg' width={40} height={40} alt='Instagram' />
						</a>
						<a href="https://x.com/devshouse_In" target="_blank" rel="noopener noreferrer" data-lenis-prevent>
							<Image style={{ height: 40, width: 'auto' }} src='footer/twitter.svg' width={40} height={40} alt='Twitter' />
						</a>
						<a href="https://www.linkedin.com/company/devshouse/" target="_blank" rel="noopener noreferrer" data-lenis-prevent>
			...
			<a href="https://devshouse25.devfolio.co/" target="_blank" rel="noopener noreferrer" data-lenis-prevent>
				<Image style={{
