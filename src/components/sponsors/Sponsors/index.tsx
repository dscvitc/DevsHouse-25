      ...
      <div className="flex flex-col items-center justify-center mt-12">
        <div className="flex justify-center w-full items-center ">
          ...
          >
            ...
            <span className="whitespace-nowrap text-[#0F9D58] mx-4 text-[25px] leading-normal font-bold px-1 font-spaceGrotesk max-xl:text-[25px] max-lg:text-[20px] max-mg:text-[15px] max-sm:text-[15px]">
            Hackathon Partner
            </span>
          <svg
            className="flex justify-start w-1/2"
